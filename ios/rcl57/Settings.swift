...
struct Settings {
    ...
    static func setTurboSpeed(_ value: Bool) {
        setBoolValue(key: IS_TURBO_KEY, value: value)
    ...
    static func getTurboSpeed() -> Bool {
        return getBoolValue(key: IS_TURBO_KEY, defaultValue: true)
    }
    ...
    static func setAlphaDisplay(_ value: Bool) {
        setBoolValue(key: IS_ALPHA_KEY, value: value)
        Rcl57.shared.setOptionFlag(option: RCL57_ALPHA_LRN_MODE_FLAG, value: value)
    }

    static func getAlphaDisplay() -> Bool {
        return getBoolValue(key: IS_ALPHA_KEY, defaultValue: true)
    }
    ...
    static func setHPLrnMode(_ value: Bool) {
        setBoolValue(key: IS_HP_KEY, value: value)
    ...
    static func setHasHaptic(_ value: Bool) {
        setBoolValue(key: IS_HAPTIC_KEY, value: value)
    }

    static func hasHaptic() -> Bool {
        return getBoolValue(key: IS_HAPTIC_KEY, defaultValue: true)
    }
    ...
    static func setHasKeyClick(_ value: Bool) {
        setBoolValue(key: IS_CLICK_KEY, value: value)
    }

    static func hasKeyClick() -> Bool {
        return getBoolValue(key: IS_CLICK_KEY, defaultValue: false)
    }
}
